...
class VamtamFramework {
	...
	public static function theme_supports() {
		...
		if ( function_exists( 'register_nav_menus' ) ) {
			register_nav_menus(
				array(
					'menu-header'  => esc_html__( 'Menu Header', 'nex' ),
					'menu-top'     => esc_html__( 'Menu Top', 'nex' ),
					'overlay-menu' => esc_html__( 'Overlay Menu', 'nex' ),
				)
			);
		}
	...
	private function load_languages() {
		load_theme_textdomain( 'nex', VAMTAM_THEME_DIR . 'languages' );
	}
