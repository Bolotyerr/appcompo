...
<table width="100%">
  ...
  <tr>
	...
	echo $options['lshowcase_carousel_pause']; ?>" onChange="lshowcaseshortcodegenerate()" /></td>
  ...
  <tr>
	...
	echo $options['lshowcase_carousel_speed']; ?>" onChange="lshowcaseshortcodegenerate()" /></td>
  </tr><tr><td colspan="2"><span class="howto">Slide transition duration (in ms - intenger) </span></td>
  </tr>
  <tr>
    <td nowrap >Image Margin:</td>
    <td><input type="text" name="lshowcase_carousel_slideMargin" value="<?php
  ...
  <tr>
    ...
    <td><input type="text" name="lshowcase_carousel_minSlides" value="<?php
  ...
  <tr>
    ...
    <td><input type="text" name="lshowcase_carousel_maxSlides" value="<?php
  ...
  <tr>
    ...
    <td><input type="text" name="lshowcase_carousel_moveSlides" value="<?php
...
<tr>
    ...
    <td><input type="text" name="lshowcase_image_size_overide" value="" size="10" onChange="lshowcaseshortcodegenerate()" /></td>
