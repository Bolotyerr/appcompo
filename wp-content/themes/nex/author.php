...
<div class="row page-wrapper">
	...
	<article class="<?php echo esc_attr( VamtamTemplates::get_layout() ) ?>">
		<div class="page-content">
			<?php if ( ! empty( $description ) ) : ?>
				<div class="author-info-box clearfix">
					...
					<div class="author-description">
						<h4><?php echo sprintf( esc_html__( 'About %s', 'nex' ), wp_kses_post( $author->data->display_name ) ); ?></h4>
			...
			<?php else : ?>
				<h2 class="no-posts-by-author"><?php sprintf( esc_html__( '%s has not published any posts yet', 'nex' ), $author->data->display_name ) ?></h2>
			<?php endif ?>
		</div>
	</article>
