...
?>
	...
	<table>
		...
		<tr>
			<td class='mega-name'>
				<?php esc_html_e( 'Mobile Top Bar', 'nex' ); ?>
				<div class='mega-description'></div>
			</td>
			<td class='mega-value'>
