...
jQuery.getScript('http://www.geoplugin.net/javascript.gp', function() 
{
  ...
  jQuery('#myModal').css('marginLeft',-jQuery('#myModal').find('.nform').width()/2);
  ...
  jQuery('.sticky_toggle').click(function(){
    ...
    jQuery(this).parents('.sticky_cover').find('.sticky_nform').slideToggle();
...
jQuery('body').on("mouseleave",'.label_smiley' , function(){
 field_hoverout(jQuery(this).attr('id'), 1);
  ...
  setInterval(function(){jq_functions();},400);
