...
/**
 * class VamtamMetaboxesGenerator
 */
class VamtamMetaboxesGenerator extends VamtamConfigGenerator {
	/**
	...
	protected function create() {
		if ( function_exists( 'add_meta_box' ) ) {
			...
			else $callback = array( &$this, 'render' );
	...
	public function render() {
		global $post, $vamtam_in_metabox;
		$vamtam_in_metabox = true;

		echo '<div class="vamtam-config-group metabox">';

		wp_nonce_field( plugin_basename( __FILE__ ), $this->config['id'] . '_noncename' );
