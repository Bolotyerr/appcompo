...
?><div class="post-content-outer single-post">
	...
	<?php if ( $meta_author || is_customize_preview() ) : ?>
		<span class="author vamtam-meta-author" <?php VamtamTemplates::display_none( $meta_author ) ?>><?php echo esc_html( _x( 'by:', 'As in: "by Author Name"', 'nex' ) ) ?><?php the_author_posts_link()?></span>
	<?php endif ?>
