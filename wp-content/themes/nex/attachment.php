...
VamtamFramework::set( 'page_title', esc_html__( 'Attachment', 'nex' ) );
	...
	<div class="row page-wrapper">
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class( VamtamTemplates::get_layout() ); ?>>
			<div class="page-content">
				...
				<div class="entry-caption">
					...
					<?php
						if ( wp_attachment_is_image() ) {
							...
							printf( esc_html__( 'Original size is %s pixels', 'nex' ),
								sprintf( '<a href="%1$s" title="%2$s">%3$s &times; %4$s</a>',
									esc_url( wp_get_attachment_url() ),
									esc_attr__( 'Link to full-size image', 'nex' ),
				...
				<?php the_content( wp_kses_post( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'nex' ) ) ); ?>
