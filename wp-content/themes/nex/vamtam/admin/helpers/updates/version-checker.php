...
esc_html_e( 'Valid Purchase Key', 'nex' );
				echo '</span>';
			} else {
				echo '<span style="color: red">';
esc_html_e( 'Incorrect Purchase Key', 'nex' );
				echo '</span>';
			}
		} else {
			echo '<span style="color: red">';
esc_html_e( 'Cannot validate Purchase Key. Please try again later. If the problem persists your server might not have the curl PHP extension enabled.', 'nex' );
			echo '</span>';
		}
